      ...
      <div className="services__container container grid">
        <div className="services__content">
          ...
          <span className="services__button" onClick={() => toggleTab(1)}>
            View more{" "}
            <i className="bx bx-chevrons-right services__button-icon"></i>
          </span>
          <div
            className={
              toggleState === 1
          ...
          >
            <div className="services__modal-content">
              ...
              <p className="services__modal-description">
                I design and build high-performance Android apps with
                user-friendly interfaces, efficient functionality, and seamless
                experiences.
              </p>
        ...
        <div className="services__content">
          ...
          >
            <div className="services__modal-content">
              ...
              <p className="services__modal-description">
                I create responsive, high-performance websites with clean
        ...
        <div className="services__content">
          ...
          >
            <div className="services__modal-content">
              ...
              <p className="services__modal-description">
                I design intuitive, user-centered interfaces that enhance user
                experiences through clean, functional, and aesthetically
                pleasing designs.
              </p>
              <ul className="services__modal-services grid">
                <li className="services__modal-service">
